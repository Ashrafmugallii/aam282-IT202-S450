                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="adminDropdown">
                            <li><a class="dropdown-item" href="<?php echo get_url('/../Project/admin/create_role.php'); ?>">Create Role</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('/../Project/admin/list_roles.php'); ?>">List Roles</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('/../Project/admin/assign_roles.php'); ?>">Assign Roles</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
            </ul>
